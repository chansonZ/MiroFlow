...
# Placeholder strings that mean "no real answer was produced".
...
# failed.  Treat all of them as equivalent to empty so the safety net can
# replace them with something useful from ExceedMaxTurnSummaryGenerator.
